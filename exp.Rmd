...
##Skills	
-	Proficient in R (including R Shiny, flexdashboard, ggplot, rjags), SPSS, Microsoft Word, Excel, PowerPoint
-	Basic Knowledge of SQL, Python, SAS, LaTeX
- Familiar with Microsoft Access, UNIX, C++, MATLAB
...
Biostatistics Consultant (June 2019 - Present)
...
- Write statistical analysis plans, build models and perform statistical analyses in R for interim and final reports, and present results to clinical study teams 
- Develop data and programming specifications jointly with programmers, validate analysis programs in R and SAS, develop R Shiny Apps for data visualization and understanding of statistical techniques
...
- Selected to lead machine learning project using hypertension data 
...
- Taught an Introduction to R Workshop and review session lectures
